//Resubmit ALL tasks of the current user
...
for (WorkflowTask workflowTask : workflowTasks) {
    ...
    WorkflowTaskManagerUtil.completeWorkflowTask(companyId, userId, workflowTask.getWorkflowTaskId(), "resubmit", StringPool.BLANK, null);
