//Reject ALL tasks Assigned to the current user
...
for (WorkflowTask workflowTask : workflowTasks) {
    ...
    WorkflowTaskManagerUtil.completeWorkflowTask(companyId, userId, workflowTask.getWorkflowTaskId(), Constants.REJECT, StringPool.BLANK, null);
